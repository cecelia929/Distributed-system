...
//					JOptionPane.PLAIN_MESSAGE);
	 ...
	 * handle the information from RemotescrabbleImpl
	 */
	@Override
...
//				JOptionPane.showMessageDialog(null,msg, null, JOptionPane.PLAIN_MESSAGE);
	...
	/**
	 * @author: Yajing
	 * Control the visibility of some sections in the frame
	 * @param istrue
	 */
	...
	/**
	 * @author: Yajing
	 * judge whether all grids are empty
	 * @return
	 */
...
//					System.exit(0);
	...
	/**
	 * @author Yajing
	 * action perform for 400 grids(buttons)
	 * judge where the user can put character
	 * @param e
	 */
	@Override
	public void actionPerformed(ActionEvent e) {
